...
if not settings.startup['seablock-evil-mode-disable-sorting-rebalance'].value then
  ...
  local chunk_catalystor_recipes = {
    ...
    ["angelsore-chunk-mix6-processing"] = {{ name ="fluorite-ore", amount = 2 }},
  ...
  local crystal_catalystor_recipes = {
    ...
    ["angelsore-crystal-mix5-processing"] = {{ name ="uranium-ore", amount = 2 }},
    ["angelsore-crystal-mix6-processing"] = {{ name ="thorium-ore", amount = 2 }},
  }

  -- Tier 4
  local pure_catalystor_recipes = {
    ["angelsore-pure-mix1-processing"] = {{ name ="tungsten-ore", amount = 4 }},
    ["angelsore-pure-mix2-processing"] = {{ name ="platinum-ore", amount = 2 }},
  ...
  local chunk_single_ore_recipes = {
    ...
    ["angelsore5-chunk-processing"] = {
      { name ="lead-ore", amount = 1}, 
      { name ="nickel-ore", amount = 2}
    },
    ["angelsore6-chunk-processing"] = {
      { name ="tin-ore", amount = 1}, 
      { name ="zinc-ore", amount = 2}
    },
  ...
  local crystal_single_ore_recipes = {
    ["angelsore1-crystal-processing"] = {
      { name ="iron-ore", amount = 1}, 
      { name ="quartz", amount = 2}, 
      { name ="rutile-ore", amount = 2}
    },
    ["angelsore2-crystal-processing"] = {
      { name ="iron-ore", amount = 1}, 
      { name ="bauxite-ore", amount = 2}, 
      { name ="cobalt-ore", amount = 2}
    },
    ["angelsore3-crystal-processing"] = {
      { name ="copper-ore", amount = 1}, 
      { name ="silver-ore", amount = 2}, 
      { name ="uranium-ore", amount = 2}
    },
  ...
  local pure_single_ore_recipes = {
    ...
    ["angelsore2-pure-processing"] = {
      ...
      { name ="copper-ore", amount = 1}, 
      { name ="bauxite-ore", amount = 2}, 
      { name ="zinc-ore", amount = 1}, 
      { name ="cobalt-ore", amount = 2}, 
      { name ="tungsten-ore", amount = 3}
    },
    ...
    ["angelsore6-pure-processing"] = {
      { name ="tin-ore",  amount = 1}, 
      { name ="quartz", amount = 2}, 
      { name ="silver-ore", amount = 3}, 
      { name ="zinc-ore", amount = 1}, 
      { name ="gold-ore", amount = 2}, 
      { name ="cobalt-ore", amount = 1}
    },
