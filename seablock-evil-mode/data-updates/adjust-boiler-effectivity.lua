local SOLID_TIER0 = 0.45  --0.85
local SOLID_TIER1 = 0.45  --0.85
local SOLID_TIER2 = 0.5   --1.0
local SOLID_TIER3 = 0.55  --1.10
local SOLID_TIER4 = 0.625 --1.25
local SOLID_TIER5 = 0.70  --1.40

local FLUID_TIER2 = 0.6
local FLUID_TIER3 = 0.7
local FLUID_TIER4 = 0.8
local FLUID_TIER5 = 0.95
